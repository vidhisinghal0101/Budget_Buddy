...
export default function ThemeSelector() {
  const { mode, toggleMode, colorTheme, changeColorTheme, currency, changeCurrency, CURRENCIES } = useTheme();
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      <button
        onClick={toggleMode}
        className="p-2 rounded-full bg-surface border border-main text-main hover:bg-primary hover:text-white hover:border-primary transition-colors shadow-sm"
        title="Toggle Theme"
      >
        {mode === 'light' ? (
          // Moon icon
